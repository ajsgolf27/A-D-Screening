...
var emotionDictionaryTest3:[String: [Float]] = [:]
...
class Step3ViewController: UIViewController {
    ...
    //MARK: outlets
    @IBAction func toResults(_ sender: AnyObject) {
        print("next button tapped")
        userAnswers.append(self.firstTextField.text!.lowercased())
        userAnswers.append(self.secondTextField.text!.lowercased())
        userAnswers.append(self.thirdTextField.text!.lowercased())
